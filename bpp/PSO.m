function [AvgCost, BestCost, BestSol, particle, it, PSOdata] = PSO(model)
...
nParticleMutation = 3;      % Number of Mutations Performed on Each Particle
nGlobalBestMutation = 20;   % Number of Mutations Performed on Global Best
